        ...
        <div class="row">
          <div class="col-md-3">           
            <div class="form-group">
              ...
              <option selected value="<?php echo $stok_buah['id_jenis_varietas'] ?>"><?php echo $stok_buah['nama_jenis'] ?></option>
          ...
          <div class="col-md-3">           
            <div class="form-group">
              ...
              <option selected value="<?php echo $stok_buah['id_varietas'] ?>"><?php echo $stok_buah['nama_varietas'] ?></option>
          ...
          <div class="col-md-3">           
            <div class="form-group">
              ...
              <option selected value="<?php echo $stok_buah['id_kelas_benih'] ?>"><?php echo $stok_buah['singkatan'] ?></option>
        ...
        <div class="row">
          <div class="col-md-4">           
            <div class="form-group">
              ...
              <input type="text" name="jumlah_stok" class="form-control" value="<?php echo $stok_buah['jumlah_stok'] ?>">
            </div>
          </div>
          <div class="col-md-4">           
            <div class="form-group">
              <label>Tersalur</label>
              <input type="text" name="tersalur" class="form-control" value="<?php echo $stok_buah['tersalur'] ?>">
            </div>
          </div> 
          <div class="col-md-4">           
            <div class="form-group">
              <label>Sisa Stok</label>
              <input type="text" name="sisa_stok" class="form-control" value="<?php echo $stok_buah['sisa_stok'] ?>">
            </div>
          </div>
