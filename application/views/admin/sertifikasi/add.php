      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-4">           
            <div class="form-group">
                ...
                <input type="text" name="nama_pemohon" class="form-control" value="<?php echo set_value('nama_pemohon') ?>" required>
              </div>
            </div> 
          ...
          <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="nama_usaha" class="form-control" value="<?php echo set_value('nama_usaha') ?>" required>
              </div>
          </div> 
          ...
          <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="no_sertifikasi" class="form-control" value="<?php echo set_value('no_sertifikasi') ?>" required>
              </div>
          </div> 
          ...
          <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" name="no_tanda_daftar" class="form-control" value="<?php echo set_value('no_tanda_daftar') ?>" required>
              </div>
          </div> 
        ...
        <div class="row">  
          <div class="col-md-4">           
            <div class="form-group">
              <label>Blok</label>
              <input type="text" name="blok" class="form-control" value="<?php echo set_value('blok') ?>">
            </div>
           </div>
           ...
           <div class="col-md-4">           
            <div class="form-group">
              <label>Kampung</label>
              <input type="text" name="kampung" class="form-control" value="<?php echo set_value('kampung') ?>">
            </div>
           </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3">           
            <div class="form-group">
              ...
              <input type="text" name="luas_penangkaran" class="form-control" value="<?php echo set_value('luas_penangkaran') ?>" required>
            </div>
           </div> 
          ...
          <div class="col-md-3">           
            <div class="form-group">
              ...
              <input type="text" name="volume" class="form-control" value="<?php echo set_value('volume') ?>" required>
            </div>
          </div>
           ...
           <div class="col-md-3">           
            <div class="form-group">
              ...
              <input type="text" name="tgl_perbanyakan" class="form-control datepicker" value="<?php echo set_value('tgl_perbanyakan') ?>" required>
            </div>
           </div>
           ...
           <div class="col-md-3">           
            <div class="form-group">
              ...
              <input type="text" name="jumlah_pohon" class="form-control" value="<?php echo set_value('jumlah_pohon') ?>">
            </div>
          </div>
        </div>
          ...
          <div class="row">  
            ...
            <div class="col-md-3">           
              <div class="form-group">
                ...
                <input type="text" name="no_kelompok_biji" class="form-control" value="<?php echo set_value('no_kelompok_biji') ?>">
              </div>
            </div> 
            ...
            <div class="col-md-3">           
              <div class="form-group">
                ...
                <input type="text" name="asal_benih_biji" class="form-control" value="<?php echo set_value('asal_benih_biji') ?>">
              </div>
            </div> 
          </div>  
        </div>
        ...
        <div id="anakan">
          ...
          <div class="row">  
            ...
            <div class="col-md-3">           
              <div class="form-group">
                <label>No. Kelompok</label>
                <input type="text" name="no_kelompok_anakan" class="form-control" value="<?php echo set_value('no_kelompok_anakan') ?>">
              </div>
            </div> 
            ...
            <div class="col-md-3">           
              <div class="form-group">
                <label>Asal Benih</label>
                <input type="text" name="asal_benih_anakan" class="form-control" value="<?php echo set_value('asal_benih_anakan') ?>">
              </div>
            </div> 
          </div>  
        </div>
          ...
          <div class="row">  
            ...
            <div class="col-md-3">           
              <div class="form-group">
                ...
                <input type="text" name="no_register_pi_okulasi" class="form-control" value="<?php echo set_value('no_register_pi_okulasi') ?>">
              </div>
            </div>
            ...
            <div class="col-md-3">           
              <div class="form-group">
                ...
                <input type="text" name="lokasi_pohon_induk" class="form-control" value="<?php echo set_value('lokasi_pohon_induk') ?>">
              </div>
            </div>
          </div>
        ...
        <div class="row">
          <div class="col-md-3">           
            <div class="form-group">
              <label>Jenis Tanaman</label>
              <input type="text" name="jenis_tanaman_tb" class="form-control" required>
            </div>
          </div>
          <div class="col-md-3">           
            <div class="form-group">
          ...
          <div class="col-md-3">           
            <div class="form-group">
              ...
              <input type="text" name="no_sertifikasi_tb" class="form-control" value="<?php echo set_value('no_sertifikasi') ?>">
            </div>
          </div>
          <div class="col-md-3">           
            <div class="form-group">
              <label>Tgl. Panen</label>
              <input type="text" name="tgl_panen_tb" class="form-control datepicker" value="<?php echo set_value('tgl_panen_tb') ?>">
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-3">           
            <div class="form-group">
              ...
              <input type="text" name="tgl_permohonan" class="form-control datepicker" value="<?php echo set_value('tgl_permohonan') ?>">
            </div>
          </div>
        </div> 
