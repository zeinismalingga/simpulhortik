  ...
  <section class="content">
    ...
    <div class="box">
      ...
      <div class="box-body">
        ...
        <a href="<?php echo base_url("$class/add") ?>" class="btn btn-success pull-right">+ Tambah</a><br><br>
              ...
              <tbody>
                ...
                <?php foreach($sertifikasi as $sertifikasi_item): ?>
                  <tr>
                    ...
                    <td><?php echo $sertifikasi_item['nama_pemohon']; ?></td>
                    <td><?php echo $sertifikasi_item['alamat']; ?></td>
                    <td>
                      <?php 
                        if($sertifikasi_item['jenis_anggaran'] == '1'){
                          $pendahuluan = 'pendahuluan_apbn';
                        }else{
                          $pendahuluan = 'pendahuluan_apbd';
                        }
                      ?>
                     <!--  <a target="_blank" href="<?php echo base_url("$pendahuluan/list/". $sertifikasi_item['id_sertifikasi']) ?>" class="btn btn-xs btn-primary">PENDAHULUAN</a><br> -->

                      <!-- <a target="_blank" href="<?php echo base_url("pelabelan_benih/list/". $sertifikasi_item['id_sertifikasi']) ?>" class="btn btn-xs btn-primary">PEMLAB</a><br> -->
                      ...
                      <a target="_blank" href="<?php echo base_url("$class/print/". $sertifikasi_item['id_sertifikasi']) ?>" class="btn btn-xs btn-success">PRINT PERMOHONAN</a><br>
