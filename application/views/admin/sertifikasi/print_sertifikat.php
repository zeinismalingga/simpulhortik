...
<head>
	<meta charset="UTF-8">
	<title>PRINT SERTIFIKAT BENIH BINA</title>
...
<body>
	...
	<div class="text-center">
		<p style="text-decoration: underline;font-weight: bold;font-size: 20px">SERTIFIKAT BENIH BINA</p>
		<p>Nomor : 521/  <span style="margin-left: 10px"></span>/UPTD PSBTPH/11.2020</p>
	</div>
	...
	<p style="line-height: 1.5">Telah memenuhi standar mutu sebagai " Benih Bina Sertifikat ". Dengan demikian dapat diberikan label berwarna: <span style="font-weight: bold;text-decoration: underline;font-style: italic;">BIRU</span> pada setiap kemasannya dengan tanggal akhir berlaku label : <span style="font-weight: bold;">03 April 2020</span></p>
