      ...
      <div class="box-body">
        ...
        <div class="row">
          <div class="col-md-4">           
            <div class="form-group">
              ...
              <input type="text" name="jumlah_stok_bln_ini" class="form-control" >
            </div>
          </div>
          <div class="col-md-4">           
            <div class="form-group">
              <label>Tersalur</label>
              <input type="text" name="tersalur_bln_ini" class="form-control" >
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-md-4">           
            <div class="form-group">
              <label>Jumlah Stok</label>
              <input type="text" name="jumlah_stok_kumulatif" class="form-control" >
            </div>
          </div>
          <div class="col-md-4">           
            <div class="form-group">
              <label>Tersalur</label>
              <input type="text" name="tersalur_kumulatif" class="form-control" >
            </div>
          </div> 
          <div class="col-md-4">           
            <div class="form-group">
