  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if($level == "sertifikasi" or $level == "admin"): ?>
        <li class="treeview">
       ...
       <!--  <li class="treeview">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('stok_bulanan_buah/pilih') ?>"><i class="fa fa-circle"></i> Stok Bulanan Buah-Buahan</a></li>
            <li><a href="<?php echo base_url('stok_bulanan_sayur/pilih') ?>"><i class="fa fa-circle"></i> Stok Bulanan Sayur-sayuran</a></li>
            <li><a href="<?php echo base_url('inventaris_pengedar/list') ?>"><i class="fa fa-circle"></i> Inventaris Pengedar</a></li>
            <li><a href="<?php echo base_url('cek_mutu_pangan/list') ?>"><i class="fa fa-circle"></i> Cek Mutu Hortikultura</a></li>
          </ul>
        </li> 
