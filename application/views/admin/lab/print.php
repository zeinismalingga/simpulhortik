	...
	<div class="content baris">
		...
		<div class="table table-bordered">
			<table style="word-wrap: break-word;">
				...
				<tr>
					<td colspan="4">Metode Kemurnian: <?php echo $lab['metode_kemurnian'] ?></td>
					<td colspan="6" rowspan="2">
						Ket <span style="left: 650px;position: absolute;">: <?php echo $lab['ket'] ?></span><br>
						Suhu <span style="left: 650px;position: absolute;">: <?php echo $lab['suhu'] ?> </span><br>
						Media/Metode DB <span style="left: 650px;position: absolute;">: <?php echo $lab['media'] ?></span><br>
						Abnormalis <span style="left: 650px;position: absolute;">: <?php echo $lab['abnormalis'] ?></span><br>
						</td>
				</tr>
				<tr>
					<td colspan="4">Benih Gulma : <?php echo $lab['benih_gulma_gr'] ?> gram : <?php echo $lab['benih_gulma_persen'] ?> %
					</td>
				</tr>
			</table>
		</div>
