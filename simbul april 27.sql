...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 27, 2020 at 10:59 AM
...
INSERT INTO `lab` (`id_lab`, `id_lab_anggaran`, `no_lab`, `kadar_air`, `metode_ka`, `berat_cnth_kerja`, `benih_murni`, `benih_tan_lain`, `kotoran_benih`, `metode_kemurnian`, `benih_gulma_gr`, `benih_gulma_persen`, `jangka_waktu_pengujian`, `kecambah_normal`, `kecambah_abnormal`, `benih_keras`, `benih_segar`, `benih_mati`, `ket`, `suhu`, `media`, `abnormalis`, `catatan`, `tgl_pengujian`, `tgl_selesai_pengujian`, `status`, `anggaran`) VALUES
(7, 8, 'S.01', 10.2, 'open suhu tinggi', 70.23, 100.0, 0.0, '0.0', '', 0.0000, 0.0, 7, 84, 7, 0, 8, 0, '-', '24', 'kertas', 'tipe 001', '', '2020-02-05', '2020-02-16', 0, 0);
...
INSERT INTO `lab_apbn` (`id_lab_apbn`, `id_tu_apbn`, `nomor`, `no_lab`) VALUES
(8, 9, '01', 'S. 01');
...
(1, 'admin', '$2y$10$oGsTbrQ1LsuXpyvQR0Tv5OHgAU3UPU7f6wohs1.Lwe14BtuLK9i5y', 'admin', '2020-04-18 07:42:19'),
...
--
ALTER TABLE `lab_apbn`
  MODIFY `id_lab_apbn` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
